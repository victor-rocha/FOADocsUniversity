...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { curso_id: @aluno.curso_id, login: @aluno.login, nome: @aluno.nome, senha: @aluno.senha }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { curso_id: @aluno.curso_id, login: @aluno.login, nome: @aluno.nome, senha: @aluno.senha }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
